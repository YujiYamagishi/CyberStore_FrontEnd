...
export default function ProductsPage() {
    ...
    const fetchProducts = useCallback(async () => {
        try {
            ...
            if (!productsResponse.ok) throw new Error("Erro na resposta da API ao buscar produtos");
            ...
            if (!allProductsResponse.ok) throw new Error("Erro na resposta da API ao buscar todas as marcas");
